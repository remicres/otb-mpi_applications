...
class GrayScaleMorphologicalOperation : public MPIApplication
{
public:
...
/** Standard macro */
itkNewMacro(Self);
itkTypeMacro(GrayScaleMorphologicalOperation, otb::MPIApplication);
...
OTB_MPI_APPLICATION_EXPORT(GrayScaleMorphologicalOperation)
