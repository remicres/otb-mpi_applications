...
class LocalStatisticExtraction : public MPIApplication
{
public:
...
itkTypeMacro(LocalStatisticExtraction, otb::MPIApplication);
...
OTB_MPI_APPLICATION_EXPORT(LocalStatisticExtraction)
