...
class BinaryMorphologicalOperation : public MPIApplication
{
public:
...
/** Standard macro */
itkNewMacro(Self);
itkTypeMacro(BinaryMorphologicalOperation, otb::MPIApplication);
...
OTB_MPI_APPLICATION_EXPORT(BinaryMorphologicalOperation)
