...
class RigidTransformResample : public MPIApplication
{
public:
  ...
  itkTypeMacro(RigidTransformResample, otb::MPIApplication);
...
OTB_MPI_APPLICATION_EXPORT(RigidTransformResample)
