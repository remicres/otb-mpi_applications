...
namespace Wrapper
{
class BundleToPerfectSensor : public MPIApplication
{
public:
  ...
  itkTypeMacro(BundleToPerfectSensor, otb::MPIApplication);
...
private:
  ...
  void DoExecute()
  {
    ...
    ElevationParametersHandler::SetupDEMHandlerFromElevationParameters(this,"elev");
...
OTB_MPI_APPLICATION_EXPORT(BundleToPerfectSensor)
