...
class GridBasedImageResampling : public MPIApplication
{
public:
  ...
  itkTypeMacro(GridBasedImageResampling, otb::MPIApplication);
...
OTB_MPI_APPLICATION_EXPORT(GridBasedImageResampling)
