...
class ClassificationMapRegularization : public MPIApplication
{
public:
  ...
  itkTypeMacro(ClassificationMapRegularization, otb::MPIApplication);
...
OTB_MPI_APPLICATION_EXPORT(ClassificationMapRegularization)
